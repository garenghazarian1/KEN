...
5. `Google Lighthouse Audit Report - Contact Page` - 12 edges
6. `Implementation Plan` - 10 edges
7. `Detailed Todo List` - 10 edges
8. `Best Practices` - 9 edges
9. `Issues Checked` - 8 edges
10. `CSS Variables (Global Design System)` - 8 edges

## Surprising Connections (you probably didn't know these)
- `ServiceMenu()` --calls--> `buildServiceSearchCatalog()`  [INFERRED]
  src/components/serviceMenu/ServiceMenu.jsx → src/lib/business/serviceSearch.js
- `ServiceMenu()` --calls--> `searchServices()`  [INFERRED]
  src/components/serviceMenu/ServiceMenu.jsx → src/lib/business/serviceSearch.js
...
Cohesion: 0.08
Nodes (25): dependencies, framer-motion, lucide-react, minisearch, mongoose, next, react, react-dom (+17 more)
...
Cohesion: 0.21
Nodes (11): buildServiceSearchCatalog(), searchServices(), suggestServiceTitles(), ServiceMenu(), parseSubcategoryIdsParam(), resolveOpenSubcategoryIds(), resolveServiceCategoryId(), SERVICE_CATEGORY_QUERY_KEY (+3 more)
